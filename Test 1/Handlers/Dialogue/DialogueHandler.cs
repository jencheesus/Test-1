...
namespace Test_1.Handlers.Dialogue
{
    public class DialogueHandler
    {
        ...
        public async Task<bool> ProcessDialogue()
        {
            while (_currentStep != null )
            {
                ...
                bool canclled = await _currentStep.ProcessStep(_client, _channel, _user).ConfigureAwait(false);
                ...
                if (canclled)
                {
                    ...
                    {
                        Title = "The Dialogue Has sucsessfully been cancelled",
